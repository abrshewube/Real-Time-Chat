...
`, template.innerHTML.trim());
  ...
  Hooks2.SetCSRFToken = {
    ...
    setCSRFToken() {
      ...
      if (metaToken) {
        const csrfToken2 = metaToken.getAttribute("content");
        ...
        if (loginInput && !loginInput.value)
          loginInput.value = csrfToken2;
        if (registerInput && !registerInput.value)
          registerInput.value = csrfToken2;
      }
    }
  };
